...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_script(
            'alpha-color-picker', get_template_directory_uri() . '/vendor/BraadMartin-alpha-color-picker/alpha-color-picker.js', array('jquery', 'wp-color-picker'), '1.0.0', true
        );
        wp_enqueue_style(
            'alpha-color-picker', get_template_directory_uri() . '/vendor/BraadMartin-alpha-color-picker/alpha-color-picker.css', array('wp-color-picker'), '1.0.0'
        );
    }
